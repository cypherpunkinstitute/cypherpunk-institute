...
const config: Config = {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Cypherpunk Institute. <a rel="license" target="_blank" href="/licencia">Algunos derechos reservados.</a>`,
    },
    prism: {
